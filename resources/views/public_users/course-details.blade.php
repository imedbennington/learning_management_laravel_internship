            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    ...
                    <div class="section-heading">
                        ...
                        <p class="section__desc pt-2 lh-30">Learn Java In This Course And Become a Computer Programmer.
                    ...
                    <div class="course-details-content-wrap pt-90px">
                        <div class="course-overview-card bg-gray p-4 rounded">
                            ...
                            <ul class="generic-list-item overview-list-item">
                                <li><i class="la la-check mr-1 text-black"></i> Learn the core Java skills needed to
                                    apply for Java developer positions in just 14 hours.</li>
                                <li><i class="la la-check mr-1 text-black"></i> Be able to demonstrate your
                                    understanding of Java to future employers.</li>
                                ...
                                <li><i class="la la-check mr-1 text-black"></i> Be able to sit for and pass the Oracle
                                    Java Certificate exam if you choose.</li>
                                <li><i class="la la-check mr-1 text-black"></i> Learn industry "best practices" in Java
                                    software development from a professional Java developer who has worked in the
                                    language for 18 years.</li>
                                <li><i class="la la-check mr-1 text-black"></i> Obtain proficiency in Java 8 and Java
                                    11.</li>
                            </ul>
                        ...
                        <div class="course-overview-card">
                            ...
                            <p class="fs-15 pb-2">Lorem Ipsum has been the industry’s standard dummy text ever since the
                                ...
                                specimen book. It has survived not only five centuries, Lorem Ipsum has been the
                                industry’s standard dummy text ever since the 1500s, when an unknown printer took a
                                galley of type and scrambled it to make a type specimen book.</p>
                            <p class="fs-15 pb-2">It has survived not only five centuries, but also the leap into
                                electronic typesetting, remaining essentially unchanged.Lorem Ipsum is simply dummy text
                            ...
                            <p class="fs-15 pt-3 pb-2 lh-22"><strong class="font-weight-semi-bold text-black">Are you
                                    aiming to get your first Java Programming job but struggling to find out what skills
                                    employers want</strong> and which course will give you those skills?</p>
                            <p class="fs-15 pb-2">This course is designed to give you the Java skills you need to get a
                                job as a Java developer. By the end of the course, you will understand Java extremely
                                well and be able to build your own Java apps and be productive as a software developer.
                            </p>
                            <div class="collapse" id="collapseMore">
                                <p class="fs-15 pb-2">The core java material you need to learn java development is
                                    covered in the first seven sections (around 14 hours in total). The Java Basics are
                                    covered in those sections. The rest of the course covers intermediate, advanced, and
                                    optional material you do not technically need to go through.</p>
