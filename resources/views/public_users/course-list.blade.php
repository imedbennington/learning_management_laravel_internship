...
<section class="course-area section-padding">
    ...
    @foreach($courses as $course)
        <div class="filter-bar mb-4">
            <div class="col-lg-12">
                <div class="card card-item card-preview card-item-list-layout" data-tooltip-content="#tooltip_content_{{ $course->id }}">
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $course->category->name }}</h6>
                        <h5 class="card-title"><a href="#">{{ $course->title }}</a></h5>
                        <p class="card-text">{{ optional($course->uploader)->name ?? 'Unknown Uploader' }}</p>
                        <div class="rating-wrap d-flex align-items-center py-2">
                            <div class="review-stars">
                                ...
                                @endif
                                @for ($i = ceil($course->rating); $i < 5; $i++)
                                    <span class="la la-star-o"></span>
                                @endfor
                            </div>
                            <span class="rating-total pl-1">({{ $course->reviews ?? 'N/A' }})</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="card-price text-black font-weight-bold">{{ $course->price ?? 'Free' }}</p>
