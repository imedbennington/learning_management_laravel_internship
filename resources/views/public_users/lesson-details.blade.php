            ...
            <div class="container-fluid">
                <div class="main-menu-content d-flex align-items-center">
                    ...
                    <div class="course-dashboard-header-title pl-4">
                        <a href="course-details.html" class="text-white fs-15">Java Programming Masterclass for Software
                            Developers</a>
                                        ...
                                        <div class="accordion generic-accordion generic--accordion"
                                                        ...
                                                        <ul class="curriculum-sidebar-list">
                                                            <li class="course-item-link">
                                                                <div class="course-item-content-wrap">
                                                                    ...
                                                                    <div class="course-item-content">
                                                                        <h4 class="fs-15">5. Let's Have Fun - Seriously!
                                                                        </h4>
                                                                        <div class="courser-item-meta-wrap">
                                                                            <p class="course-item-meta"><i
                                                                                    class="la la-play-circle"></i>2min
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="mobileCourseHeadingThree">
                                                    <button class="btn btn-link collapsed" type="button"
                                                        data-toggle="collapse" data-target="#mobileCourseCollapseThree"
                                                        aria-expanded="false" aria-controls="mobileCourseCollapseThree">
                                                        <i class="la la-angle-down"></i>
                                                        <i class="la la-angle-up"></i>
                                                        ...
                                                        <ul class="curriculum-sidebar-list">
                                                            <li class="course-item-link">
                                                                <div class="course-item-content-wrap">
                                                                    ...
                                                                    <div class="course-item-content">
                                                                        <h4 class="fs-15">9. Let's Have Fun - Seriously!
                                                                        </h4>
                                                                        <div class="courser-item-meta-wrap">
                                                                            <p class="course-item-meta"><i
                                                                                    class="la la-play-circle"></i>2min
                                                            ...
                                                            <li class="course-item-link active-resource">
                                                                <div class="course-item-content-wrap">
                                                                    ...
                                                                    <div class="course-item-content">
                                                                        <h4 class="fs-15">11. Download your Footage for
                                                                            your Quick Start</h4>
                                                                        <div class="courser-item-meta-wrap">
                                                                            <p class="course-item-meta"><i
                                                                                    class="la la-file"></i>2min</p>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="mobileCourseHeadingFour">
                                                    <button class="btn btn-link collapsed" type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="mobileCourseCollapseFour">
                                                        <i class="la la-angle-down"></i>
                                                        <i class="la la-angle-up"></i>
                                                        ...
                                                        <ul class="curriculum-sidebar-list">
                                                            <li class="course-item-link">
                                                                <div class="course-item-content-wrap">
                                                                    ...
                                                                    <div class="course-item-content">
                                                                        <h4 class="fs-15">13. Bonus Courses - Learn more
                                                                            for less</h4>
                                                                        <div class="courser-item-meta-wrap">
                                                                            <p class="course-item-meta"><i
                                                                                    class="la la-play-circle"></i>2min
                                            ...
                                            <ul class="curriculum-sidebar-list">
                                                ...
                                                <li class="course-item-link active-resource">
                                                    <div class="course-item-content-wrap">
                                                        ...
                                                        <div class="course-item-content">
                                                            <h4 class="fs-15">11. Download your Footage for your Quick
                                                                Start</h4>
                                                            <div class="courser-item-meta-wrap">
                                                                <p class="course-item-meta"><i
                                                                        class="la la-file"></i>2min</p>
