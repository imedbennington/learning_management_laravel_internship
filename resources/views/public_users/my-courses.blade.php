                ...
                <div class="tab-pane fade show active" id="all-course" role="tabpanel" aria-labelledby="all-course-tab">
                    <div class="my-course-body">
                        <div class="alert alert-info alert-dismissible fade show course-alert-info" role="alert">
                            <div class="d-flex align-items-center">
                                <i class="la la-users fs-40"></i> <a href="invite.html" class="alert-link font-weight-medium pl-4">Share Aduca with friends</a>
                            </div>
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="allCourseMenuLink">
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="allCourseMenuLinkThree">
                                                            <h6 class="dropdown-header text-black">Collections</h6>
                                                            <a href="javascript:void(0)" class="dropdown-item collection-link d-flex align-items-center justify-content-between">
                                                                <span>Javascript</span>
                                                                <span class="la la-check collection-icon"></span>
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="allCourseMenuLinkFour">
                                                            <h6 class="dropdown-header text-black">Collections</h6>
                                                            <a href="javascript:void(0)" class="dropdown-item collection-link d-flex align-items-center justify-content-between">
                                                                <span>Javascript</span>
                                                                <span class="la la-check collection-icon"></span>
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="allCourseMenuLinkSix">
                                                            <h6 class="dropdown-header text-black">Collections</h6>
                                                            <a href="javascript:void(0)" class="dropdown-item collection-link d-flex align-items-center justify-content-between">
                                                                <span>Javascript</span>
                                                                <span class="la la-check collection-icon"></span>
                            ...
                            <div class="my-course-info pb-40px">
                                <div class="d-flex align-items-center pb-2">
                                    ...
                                    <div class="my-course-info-action ml-2">
                                        <span class="la la-edit icon-element icon-element-xs cursor-pointer shadow-sm" data-toggle="modal" data-target="#editCollectionModal" title="Edit"></span>
                                        <span class="la la-trash icon-element icon-element-xs cursor-pointer shadow-sm" data-toggle="modal" data-target="#deleteModal" title="Delete"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLink">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLinkTwo">
                                                                <a href="javascript:void(0)" class="dropdown-item">
                                                                    Remove from Collection
                                                                </a>
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title"><a href="lesson-details.html">Modern JavaScript From The Beginning</a></h5>
                                                <p class="card-text lh-22 pt-2"><a href="teacher-detail.html">Jose Portilla</a><span>, Software Engineer and Developer</span></p>
                                                <div class="my-course-progress-bar-wrap d-flex flex-wrap align-items-center mt-3 position-relative">
                                                    <p class="skillbar-title">Complete:</p>
                                                    <div class="skillbar-box">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLinkThree">
                                                                <a href="javascript:void(0)" class="dropdown-item">
                                                                    Remove from Collection
                                                                </a>
                                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLinkFour">
                                                                <a href="javascript:void(0)" class="dropdown-item">
                                                                    Remove from Collection
                                                                </a>
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title"><a href="lesson-details.html">An Entire MBA in 1 Course:Award Winning Business School Prof</a></h5>
                                                <p class="card-text lh-22 pt-2"><a href="teacher-detail.html">Jose Portilla</a><span>, Software Engineer and Developer</span></p>
                                                <div class="my-course-progress-bar-wrap d-flex flex-wrap align-items-center mt-3 position-relative">
                                                    <p class="skillbar-title">Complete:</p>
                                                    <div class="skillbar-box">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLinkFive">
                                                                <a href="javascript:void(0)" class="dropdown-item">
                                                                    Remove from Collection
                                                                </a>
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title"><a href="lesson-details.html">The Complete Financial Analyst Course 2020</a></h5>
                                                <p class="card-text lh-22 pt-2"><a href="teacher-detail.html">Jose Portilla</a><span>, Software Engineer and Developer</span></p>
                                                <div class="my-course-progress-bar-wrap d-flex flex-wrap align-items-center mt-3 position-relative">
                                                    <p class="skillbar-title">Complete:</p>
                                                    <div class="skillbar-box">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item">
                                                ...
                                                <div class="course-badge-labels course--badge-labels">
                                                    <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="collectionMenuLinkSix">
                                                                <a href="javascript:void(0)" class="dropdown-item">
                                                                    Remove from Collection
                                                                </a>
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title"><a href="lesson-details.html">Ninja Writing: The Four Levels Of Writing Mastery</a></h5>
                                                <p class="card-text lh-22 pt-2"><a href="teacher-detail.html">Jose Portilla</a><span>, Software Engineer and Developer</span></p>
                                                <div class="my-course-progress-bar-wrap d-flex flex-wrap align-items-center mt-3 position-relative">
                                                    <p class="skillbar-title">Complete:</p>
                                                    <div class="skillbar-box">
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="archiveMenuLink">
                                                            <a href="javascript:void(0)" class="dropdown-item d-flex align-items-center justify-content-between">
                                                                <span>Unarchive</span>
                                                                <i class="la la-archive"></i>
                                                            </a>
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="archiveMenuLinkTwo">
                                                            <a href="javascript:void(0)" class="dropdown-item d-flex align-items-center justify-content-between">
                                                                <span>Unarchive</span>
                                                                <i class="la la-archive"></i>
                                                            </a>
                                            ...
                                            <div class="course-badge-labels course--badge-labels">
                                                <div class="generic-action-wrap generic--action-wrap generic--action-wrap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-wrap" aria-labelledby="archiveMenuLinkThree">
                                                            <a href="javascript:void(0)" class="dropdown-item d-flex align-items-center justify-content-between">
                                                                <span>Unarchive</span>
                                                                <i class="la la-archive"></i>
                                                            </a>
...
<!-- Modal -->
<div class="modal fade modal-container" id="createNewCollectionModal" tabindex="-1" role="dialog" aria-labelledby="createNewCollectionModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                ...
                <form action="#">
                    <div class="input-box">
                        ...
                        <div class="form-group">
                            <input class="form-control form--control pl-3" type="text" name="text" placeholder="Name your collection e.g. HTML skills">
                        </div>
                    </div>
                    <div class="input-box">
                        <label class="label-text">Description</label>
                        <div class="form-group">
                            <textarea class="form-control form--control pl-3" name="message" rows="5" placeholder="Why are you creating this collection? e.g. To start a new business, To get a new job, To become a web developer"></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="#">
                    <div class="input-box">
                        <label class="label-text">Collection Title</label>
                        <div class="form-group">
                            <input class="form-control form--control pl-3" type="text" name="text" value="Javascript">
                        </div>
                    </div>
                    <div class="input-box">
                        <label class="label-text">Description</label>
                        <div class="form-group">
                            <textarea class="form-control form--control pl-3" name="message" rows="5">Leading the basics fundamentals</textarea>
                        </div>
                    </div>
                    <div class="btn-box text-right pt-2">
                        <button type="button" class="btn font-weight-medium mr-3" data-dismiss="modal">Cancel</button>
