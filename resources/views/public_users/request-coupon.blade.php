        ...
        <div class="container">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                <div class="section-heading">
                    <h2 class="section__title text-white">Apply for coupon</h2>
                </div>
                <ul
                    class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
                    <li><a href="index.html">Home</a></li>
                    <li>Pages</li>
                    <li>Apply for coupon</li>
                </ul>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <!-- resources/views/students/request-coupon.blade.php -->
                            <form method="POST" action="{{ route('coupons.request') }}">
                                @csrf
                                <input type="hidden" name="student_id" value="{{ $student->id }}">
                                <input type="hidden" name="student_name" value="{{ $student->first_name }}">
                                ...
                                <button type="submit" class="btn btn-primary">Request Coupon</button>
                            </form>
