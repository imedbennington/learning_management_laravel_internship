                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap align-items-center pb-4">
                            <button type="submit" formaction="{{ route('register.google') }}" class="btn theme-btn flex-grow-1 mx-2 mb-2">
                                <i class="la la-google mr-2"></i>Google
                            </button>
                            <button type="submit" formaction="{{ route('register.facebook') }}" class="btn theme-btn flex-grow-1 mx-2 mb-2">
                                <i class="la la-facebook mr-2"></i>Facebook
                            </button>
                            <button type="submit" formaction="{{ route('register.twitter') }}" class="btn theme-btn flex-grow-1 mx-2 mb-2">
