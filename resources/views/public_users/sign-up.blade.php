                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-sign-in mr-1"></i><a href="{{ route('log_in') }}">Login</a>
...
<section class="contact-area section--padding position-relative">
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ route('register.submit') }}" class="pt-4">
    @csrf
    <div class="d-flex flex-wrap align-items-center pb-4">
        <button type="button" onclick="window.location.href=''" class="btn theme-btn flex-grow-1 mx-2 mb-2">
            <i class="la la-google mr-2"></i>Google
        </button>
        <button type="button" onclick="window.location.href=''" class="btn theme-btn flex-grow-1 mx-2 mb-2">
            <i class="la la-facebook mr-2"></i>Facebook
        </button>
        <button type="button" onclick="window.location.href='{{ route('register.twitter') }}'" class="btn theme-btn flex-grow-1 mx-2 mb-2">
    ...
    <div class="input-box">
        ...
        <div class="form-group">
            <input class="form-control form--control" type="text" name="first_name" placeholder="First name" required>
    ...
    <div class="input-box">
        ...
        <div class="form-group">
            <input class="form-control form--control" type="text" name="last_name" placeholder="Last name" required>
            <span class="la la-user input-icon"></span>
        </div>
    </div>
    <div class="input-box">
    ...
    <div class="form-group">
        <input class="form-control form--control" type="password" name="password_confirmation" placeholder="Confirm Password" required>
        <span class="la la-lock input-icon"></span>
    </div>
</div>
    <div class="btn-box">
        ...
        <div class="custom-control custom-checkbox mb-4 fs-15">
            ...
            <label class="custom-control-label custom--control-label" for="agreeCheckbox">by signing i agree to Aduca's <a href="privacy-policy.html" class="text-color hover-underline">Privacy Policy.</a></label>
        </div>
